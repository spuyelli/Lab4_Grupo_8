...
INSERT INTO usuarios (nombreUsuario,pass,tipoUsuario,dni,nombre,apellido) VALUES ('admin','admin',1,30600282,'Pepe','Perez');
INSERT INTO usuarios (nombreUsuario,pass,tipoUsuario,dni,nombre,apellido) VALUES ('user1','user1',2,30600282,'Marcela','Fernandez');
INSERT INTO usuarios (nombreUsuario,pass,tipoUsuario,dni,nombre,apellido) VALUES ('user2','user2',2,30600282,'Jose','Rodriguez');
...
INSERT INTO seguros (descripcion,idTipo,costoContratacion,costoAsegurado) VALUES ('Es un seguro de salud para intervenciones quirúrgicas de alta complejidad, a un costo accesible.',1,600, 15000);
...
CREATE PROCEDURE traerUnUsuarios(
NombreU VARCHAR(25) )
